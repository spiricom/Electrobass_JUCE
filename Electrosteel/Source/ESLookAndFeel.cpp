...
void ESLookAndFeel::drawButtonBackground (Graphics& g,
                                          Button& button,
...
void ESLookAndFeel::drawButtonText (Graphics& g, TextButton& button,
...
void ESLookAndFeel::drawLinearSlider (Graphics& g, int x, int y, int width, int height,
                                      float sliderPos,
                                      float minSliderPos,
                                      float maxSliderPos,
...
void ESLookAndFeel::drawRotarySlider(Graphics& g, int x, int y, int width, int height, float sliderPos, const float rotaryStartAngle, const float rotaryEndAngle, Slider& slider)
{
...
void ESLookAndFeel::drawPopupMenuItem (Graphics& g, const Rectangle<int>& area,
...
int ESLookAndFeel::getTabButtonBestWidth(TabBarButton & button, int tabDepth)
{
...
Rectangle<int> ESLookAndFeel::getTabButtonExtraComponentBounds (const TabBarButton& button, Rectangle<int>& textArea, Component& comp)
{
    auto depth = button.getHeight();
    return textArea.reduced(depth*0.2f, depth*0.2f);
}

void ESLookAndFeel::drawTableHeaderColumn (Graphics& g, TableHeaderComponent& header,
